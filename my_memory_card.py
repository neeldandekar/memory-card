...
question_list = []
q1 = Question('How do you greet someone in spanish', 'hola', 'ola', 'olaa', 'hello')
q2 = Question('How often is a Cricket new ball given to players', '80overs', '3 overs', '1 over', '75 overs')
q3 = Question('How many books in the Diary of A wimpy kid series are there', '17', '13', '14', '16')
q4 = Question('How many IPL teams are there', '8', '16', '20', '10')
